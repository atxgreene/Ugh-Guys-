...
export const Sound = {
  ...
  abilityBuff()  { tone(660, 0.05, 'triangle', 0.07); setTimeout(() => tone(880, 0.12, 'triangle', 0.09, 120), 55); },
  abilityDebuff(){ tone(280, 0.2, 'sawtooth', 0.07, -120); noiseBurst(0.14, 0.04, 600); },
  abilityAoe()   { noiseBurst(0.18, 0.1, 220); tone(180, 0.22, 'sawtooth', 0.07, -80); setTimeout(() => noiseBurst(0.12, 0.06, 440), 80); },
