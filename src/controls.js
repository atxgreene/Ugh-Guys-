...
export class Controls {
  ...
  syncHoverRing() {
    ...
    this.hoverRing.material.color.set(
      e.isResource ? 0xd8b75a : e.owner === this.game.localPlayer ? 0x9be86e : e.owner === this.game.NEUTRAL ? 0xcccc88 : 0xff7066);
  ...
  syncSelectionRings() {
    ...
    for (let i = 0; i < this.selRings.length; i++) {
      ...
      ring.material.color.set(e.owner === this.game.localPlayer ? 0x66ff88 : e.owner === this.game.NEUTRAL ? 0xcccc88 : 0xff5544);
